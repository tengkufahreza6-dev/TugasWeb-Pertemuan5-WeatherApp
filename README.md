...
Aplikasi pemantau cuaca interaktif berbasis **Vanilla JavaScript ES6+** yang terintegrasi dengan **OpenWeatherMap API**. Dibuat dengan arsitektur modul bersih (*clean code*), penanganan *error* yang tangguh, serta antarmuka responsif *Glassmorphism*.
...
3. **Komponen Informasi Cuaca:** Menampilkan nama kota, tanggal, derajat suhu, deskripsi cuaca, ikon cuaca resmi, kelembaban, kecepatan angin, dan suhu terasa.
...
8. **Fitur Bonus (Lengkap):**
   ...
   - **Dynamic HD Background:** Latar belakang gambar HD dinamis (Unsplash) yang berganti otomatis sesuai kondisi cuaca.
...
└── js/
    ...
    ├── ui.js        (Modul Manipulasi DOM & Dynamic Rendering)
